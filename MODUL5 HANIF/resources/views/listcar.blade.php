  ...
  <body>
    ...
    <nav class="navbar fixed-top" style="background:#3563E9">
        <div class="container">
          <ul class="nav">
            <li class="nav-item">
              <a class="nav-link" href="logon-hanif.php" style="color:#E0E0E0">Home</a>
            </li>
            <li class="nav-item">
    ...
    <div class="add-mainContainer">
        ...
        <div class="phpset" style="display: flex;">
          ...
          <?php
            ...
            $data = mysqli_query($connect,"SELECT * FROM showroom_hanif_table"); //debug dari showrom_hanif_table
            if ($data->num_rows==0) {
